...
public class CarreraRunnable implements Runnable {
    ...
    final int N = 10;       // cantidad de veces que cada proceso va a incrementar/decrementar
    final static int M = 2; // cantidad de hilos incrementador/decrementador respectivamente
   ...
   /**
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i=0; i<M; i++){
            incre [i]= new Thread (new CarreraRunnable(1));     //se llena el array de los incrementadores
            decre [i]= new Thread (new CarreraRunnable(-1));    //se llena el array de los decrementadores
